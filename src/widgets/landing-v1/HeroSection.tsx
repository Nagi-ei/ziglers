...
export function HeroSection() {
  return (
    <section className="relative min-h-[calc(100vh-12rem)] w-full overflow-hidden bg-background">
      <div
      ...
      <div className="relative z-10 mx-auto flex max-w-7xl items-center justify-center gap-16 px-4 py-16 lg:py-24">
        <div className="flex max-w-3xl flex-col items-center gap-8 text-center">
          <h1 className="font-semibold text-4xl text-foreground leading-tight tracking-tight sm:text-5xl lg:text-7xl">
            Build Your <br />
            <span className="relative mt-2 inline-block transform bg-foreground px-4 py-1 text-background">
              Success Stack
            </span>
          </h1>
            ...
            >
              {item.isCenter ? (
                <div className="z-10 flex flex-col items-center gap-2 text-center">
                  ...
                  <span className="font-semibold text-4xl leading-none sm:text-5xl lg:text-6xl">
                    64
                  </span>
