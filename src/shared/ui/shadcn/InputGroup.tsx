...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/noStaticElementInteractions: UI convenience for focusing input
    // biome-ignore lint/a11y/useKeyWithClickEvents: non-essential enhancement
    <div
      // role="group"
